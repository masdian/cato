...
date: '2020-03-18'
highlight: no
lastmod: '2020-03-18T13:19:37+07:00'
layout: post
...
Data hasil unduhan berupa file csv. Data tersebut bisa dibuka menggunakan sintaks berikut
...
Sintaks berikut akan membuat tabel baru yang berisi peubah (*varable*) `gender`, `country`, dan agregat `hours_per_week` yang diberi nama `total_hours`. Kemudian data diurutkan secara menurun (*descending*) berdasarkan `total_hours`.
